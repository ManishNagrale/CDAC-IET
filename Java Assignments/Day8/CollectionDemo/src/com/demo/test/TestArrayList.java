...
public class TestArrayList {
	public static void main(String[] args) {
		...
		elist.add(new Employee(12,"Manish",45678,LocalDate.of(2025,02,10)));
		elist.add(new Employee(13,"Mayur",56678,LocalDate.of(2025,07,10)));
		elist.add(new Employee(15,"Saurabh",35678,LocalDate.of(2025,03,10)));
